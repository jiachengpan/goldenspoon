...
training_model=adaboostclassifier #adaboostregressor     # ['linear', 'ridge', 'lasso', 'randomforest', 'randomforestclssifier', 'adaboostregressor', 'adaboostclassifier']
...
if [ "${debug_mode}" = "T" ]; then
  savepath=regress_result/test/adaboost_randomforest/${flag}
else
